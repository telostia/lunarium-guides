...
#get wallet files
sudo wget https://github.com/LunariumCoin/lunarium/releases/download/v1.1.1/lunarium-1.1.1-x86_64-linux-gnu.tar.gz
#tar -xvf lunarium-linux.tar.gz
#untar and strip unwanted directories to current folder
sudo chmod +x lunarium-1.1.1-x86_64-linux-gnu.tar.gz
sudo tar --strip-components=2 -zxf lunarium-1.1.1-x86_64-linux-gnu.tar.gz
